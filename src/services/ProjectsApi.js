...
export async function loadProjects() {
  try {
    ...
    if (!response.ok) {
      throw new Response(JSON.stringify({ message: resData.message }), {
...
export async function loadProjectDetails(id) {
  try {
    const response = await fetch(
      `${baseUrl}/api/Project/project-detail?projectId=` + id,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export async function importTraineesForProject(projectId, formData) {
  ...
  try {
    const response = await fetch(
      `${baseUrl}/api/Trainee/import-trainee?projectId=${projectId}`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
...
export async function unActiveProject(id) {
  try {
    const response = await fetch(
      `${baseUrl}/api/Project/inactivated-project?projectID=${id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export async function getProjectLog(
  ...
  try {
    const response = await fetch(
      `${baseUrl}/api/ProjectLogging/all-project-logging?projectId=${projectId}&searchValue=${searchValue}&pageNumber=${pageNumber}&rowsPerPage=${rowsPerPage}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export async function toUpComingProject(projectId) {
  try {
    const response = await fetch(
      `${baseUrl}/api/Project/to-up-coming-status?projectId=${projectId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
    ...
    if (!response.ok) {
      throw new Error(
        resData.result || resData.message || "Lỗi không xác định từ API"
      );
    }
    ...
    console.error(
      "❌ Lỗi khi chuyển trạng thái dự án:",
      error.result || error.message
    );
    throw new Error(
      error.result || error.message || "Có lỗi xảy ra khi chuyển trạng thái"
    );
  }
}
...
export async function toInProgressProject(projectId) {
  try {
    const response = await fetch(
      `${baseUrl}/api/Project/to-in-progress-status?projectId=${projectId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export async function toEndProject(projectId) {
  try {
    const response = await fetch(
      `${baseUrl}/api/Project/to-end-status?projectId=${projectId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export async function updateProjectStandard(payload) {
  console.log(payload);
  const response = await fetch(
    `${baseUrl}/api/Project/max-absent-percentage-and-failing-score`,
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
  ...
  if (!response.ok) {
    ...
    const error = new Error(
      errorData.message || "Không thể cập nhật tiêu chuẩn đánh giá"
    );
    error.result = errorData.result || [];
    throw error;
  }
