...
export const GetAllTraineeOfClass = async (
  classId,
  searchValue,
  pageNumber,
  rowsPerPage,
...
export async function submitReportTrainee(accountId, classId, formData) {
  ...
  try {
    const response = await fetch(
      `${baseUrl}/api/Trainee/trainee-report?accountId=${accountId}&classId=${classId}`,
      {
        method: "PUT",
        headers: {
...
export const ExportTraineeListTemplate = async (classId) => {
  try {
    var url = `${baseUrl}/api/Trainee/export-trainee-template?classId=${classId}`;
    const request = {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function searchClassTrainees(currentClassId, accountId) {
  try {
    const response = await fetch(
      `${baseUrl}/api/Class/all-available-class?accountId=${accountId}&currentClassId=${currentClassId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export async function searchGroupTrainees(currentClassId, accountId) {
  try {
    const response = await fetch(
      `${baseUrl}/api/Trainee/available-group-of-class?currentClassId=${currentClassId}&accountId=${accountId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
