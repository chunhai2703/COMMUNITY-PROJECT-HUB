  ...
  return (
    <div className={cx('dashboard-container')}>
      ...
      <div className={cx('shortcut-container')}>
        <Card className={cx('shortcut-card')} size="default" onClick={() => navigate('/home-student/all-related-projects')}>
          <p className={cx('shortcut-title')} > <ProjectFilled style={{ fontSize: '20px', color: '#60B5FF', marginRight: '10px' }} /> Dự Án Của Tôi</p>
        </Card>
        <Card className={cx('shortcut-card')} size="default" onClick={() => navigate('/home-student/my-classes')}>
          <p className={cx('shortcut-title')} > <SnippetsFilled style={{ fontSize: '20px', color: '#FF9B17', marginRight: '10px' }} /> Lớp học của tôi</p>
        </Card>
        <Card className={cx('shortcut-card')} size="default" onClick={() => navigate('/home-student/my-schedule')}>
