...
const items = [
  {
    ...
    children: (
      <ul style={{ paddingLeft: "1rem", fontSize: "16px" }}>
        ...
        <li>
          Nếu bạn có kỹ năng về{" "}
          <span style={{ fontWeight: "600" }}>
            quản lý, truyền thông, thiết kế, lập trình
          </span>
          , dự án sẽ tận dụng tốt hơn sự giúp đỡ của bạn.
        </li>
      </ul>
    ),
  },
  {
    ...
    children: (
      <ul style={{ paddingLeft: "1rem", fontSize: "16px" }}>
        <li>
          ✅ Kỹ năng <span style={{ fontWeight: "600" }}>làm việc nhóm</span> và{" "}
          <b>giao tiếp</b> với nhiều người.
        </li>
        <li>
          ✅ Cách{" "}
          <span style={{ fontWeight: "600" }}>tổ chức và quản lý sự kiện</span>.
        </li>
        <li>
          ✅ <span style={{ fontWeight: "600" }}>Tư duy cộng đồng</span> và cách
          tạo ra tác động xã hội.
        </li>
        <li>
          ✅ <span style={{ fontWeight: "600" }}>Kết nối</span> với những người
          cùng chí hướng, mở rộng quan hệ.
        </li>
      </ul>
    ),
  },
  {
    ...
    children: (
      <ul style={{ paddingLeft: "1rem", fontSize: "16px" }}>
        <li>
          ✅ <span style={{ fontWeight: "600" }}>Chia sẻ thông tin</span> trên
          mạng xã hội để giúp dự án tiếp cận nhiều người hơn.
        </li>
        <li>
          ✅ <span style={{ fontWeight: "600" }}>Tham gia hỗ trợ từ xa</span>:
          viết nội dung, thiết kế, hoặc giúp đỡ về công nghệ.
        </li>
        <li>
          ✅{" "}
          <span style={{ fontWeight: "600" }}>Góp một khoản nhỏ vào quỹ</span>{" "}
          nếu dự án cần tài trợ.
        </li>
      </ul>
    ),
  },
  ...
  return (
    <div className={cx("dashboard-container")}>
      ...
      <div className={cx("collapse-container")}>
        <h2 className={cx("collapse-title")}>
          Những câu hỏi thường gặp <QuestionCircleOutlined />
        </h2>
        <Collapse
          items={items}
          defaultActiveKey={["1"]}
