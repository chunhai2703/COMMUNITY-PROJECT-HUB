      ...
      <div style={{ margin: "0 20px" }}>
        <div className={style.infoContainer}>
          <div className={style.infoHeader}>
            <p>
              <CalendarToday /> Thông tin chung
            </p>
          </div>
          <div className={style.info}>
            <div className="flex mb-5">
              <p className="mr-10 font-bold w-1/3">
                <RecordVoiceOver /> Giảng viên
              </p>
              {dataClass.lecturerName ? (
                <p>{dataClass.lecturerName}</p>
              ) : (
                <p style={{ color: "red", fontWeight: 500 }}>Chưa có</p>
              )}
            </div>
            <div className="flex mb-5">
              <p className="mr-10 font-bold w-1/3">
                <StarBorderIcon /> Sinh viên hỗ trợ
              </p>
              <div>
        ...
        <div className={style.tabContainer}>
          ...
          {(user.roleId === 4 ||
            ...
            (user.roleId === 3 &&
              dataClass.getTraineeOfClassDTOs.some(
                (trainee) => trainee.accountId === user.accountId
              )) ||
            (user.roleId === 1 &&
              dataClass.getMemberOfClassDTOs.some(
        ...
        <div className={style.componentTab}>
          ...
          {(user.roleId === 4 ||
            ...
            activeTab === "traineeList" && (
              <TraineeList dataClass={dataClass} />
            )}
          ...
          {user.roleId === 3 &&
            ...
            activeTab === "changeGroup" && (
              <ChangeGroup
                dataClass={dataClass}
                refresh={fetchGetClassDetail}
              />
            )}
          ...
          {(user.roleId === 4 ||
            ...
            user.roleId === 5 ||
            user.roleId === 6) &&
            activeTab === "evaluateResult" && (
              <TraineeScoreList dataClass={dataClass} />
            )}
