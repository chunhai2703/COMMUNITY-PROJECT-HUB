    ...
    <Box className="ml-4 mr-4">
      ...
      <Box className="mb-6 flex justify-between">
        <div>
          ...
          >
            <Search sx={{ fontSize: 18, marginRight: "5px" }} /> Tìm kiếm
          </Button>
        </div>
        <div>
          <Button
          ...
          <Button
            ...
            sx={{ textTransform: "none" }}
            style={{ backgroundColor: "#474D57", marginLeft: 10 }}
            onClick={handleOpenCreateAssociate}
          >
            Tạo mới đối tác
          </Button>
          <Button
      ...
      <AccountTable
        ...
        onUpdateAssociate={handleOpenUpdateAssociate}
        onInactive={handleOpenInactive}
      />
      ...
      <Dialog open={isImportOpen} onClose={handleClosePopup}>
        ...
        <DialogContent>
          ...
          >
            <p style={{ fontWeight: "500", fontSize: "24px", marginTop: 10 }}>
              Danh sách tài khoản
            </p>{" "}
            <input
              type="file"
            ...
            {selectedFile && (
              <p style={{ marginTop: 10 }}>{selectedFile.name}</p>
            )}
            {errorListImporting &&
              errorListImporting.map((error, index) => (
                <p key={index} style={{ color: "red", marginTop: 5 }}>
                  • {error}
                </p>
              ))}
          </div>
      ...
      <Dialog open={isCreateOpen} onClose={handleClosePopup}>
        ...
        <DialogContent className="mt-2">
          <form onSubmit={handleSubmit(onSubmitCreate)}>
            ...
            <DialogActions>
              <Button onClick={handleClosePopup} sx={{ textTransform: "none" }}>
                Hủy
              </Button>
              <Button
                type="submit"
      ...
      <Dialog open={isInactiveOpen} onClose={handleClosePopup}>
        ...
        <DialogContent>
          <p className="pt-3 pb-3">
            Bạn có chắc muốn vô hiệu hóa tài khoản có ID:{" "}
